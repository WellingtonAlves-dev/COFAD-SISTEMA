    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url("/")}}">
                ...
                <div class="sidebar-brand-text mx-3">{{env("APP_NAME")}} - {{Auth::user()->role == 1 ? "ADM" : "COORD"}}</div>
            </a>
            ...
            @endif
            <li class="nav-item active">
                <a class="nav-link" href="{{url("/professores")}}">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url("/faltas")}}">
                        ...
                        */
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{url("usuarios/".Auth::user()->id)}}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; WellTech {{date("Y")}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Desconectando...</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">A sua sessão será encerrada. Deseja continuar?</div>
